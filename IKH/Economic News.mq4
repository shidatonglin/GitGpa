...
color	VertTxtColor 		= Black;		// Color of our vertical text color 
...
/* not working:
    ...
    working: http://cdn.forexfactory.com/ffcal_week_this.xml
*/
...
int start()
{
	...
	if (AllowWebUpdates)
	{
  			...
  			(TimeCurrent() - GlobalVariableGet("LastUpdateTime")) > 14400)
		{
			...
			if (end <= 0)
			{
				if (AlertsOnErrors == true) Alert("FFCal Error - Web page download was not complete!");
				return(false);
			}
			else
			{
