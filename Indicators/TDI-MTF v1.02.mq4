...
int start() {
  ...
  for(i=iNewBars; i>=0; i--) {      
    // Get TDI Data
    dBuffer0[i]=iCustom(NULL,iTimeFrame,TDI_INDI,TDI.RSIPeriod,TDI.RSIPrice,TDI.VolatilityBand,TDI.RSIPriceLine,
                        TDI.RSIPriceType,TDI.TradeSignalLine,TDI.TradeSignalType,1,iBarShift(Symbol(), iTimeFrame, Time[i]));       // Upper Blue line
    dBuffer1[i]=iCustom(NULL,iTimeFrame,TDI_INDI,TDI.RSIPeriod,TDI.RSIPrice,TDI.VolatilityBand,TDI.RSIPriceLine,
                            TDI.RSIPriceType,TDI.TradeSignalLine,TDI.TradeSignalType,2,iBarShift(Symbol(), iTimeFrame, Time[i]));   // Yellow line
    dBuffer2[i]=iCustom(NULL,iTimeFrame,TDI_INDI,TDI.RSIPeriod,TDI.RSIPrice,TDI.VolatilityBand,TDI.RSIPriceLine,
                       TDI.RSIPriceType,TDI.TradeSignalLine,TDI.TradeSignalType,3,iBarShift(Symbol(), iTimeFrame, Time[i]));        // Lower Blue line
    dBuffer3[i]=iCustom(NULL,iTimeFrame,TDI_INDI,TDI.RSIPeriod,TDI.RSIPrice,TDI.VolatilityBand,TDI.RSIPriceLine,
                          TDI.RSIPriceType,TDI.TradeSignalLine,TDI.TradeSignalType,4,iBarShift(Symbol(), iTimeFrame, Time[i]));     // Green line
    dBuffer4[i]=iCustom(NULL,iTimeFrame,TDI_INDI,TDI.RSIPeriod,TDI.RSIPrice,TDI.VolatilityBand,TDI.RSIPriceLine,
                            TDI.RSIPriceType,TDI.TradeSignalLine,TDI.TradeSignalType,5,iBarShift(Symbol(), iTimeFrame, Time[i]));  // Red line
  }
  // Bye bye  
  return(0);
}
