...
color ArrowsColorUp=Aqua;       // color for the orders arrows
color ArrowsColorDown=Red;       // color for the orders arrows
color ArrowsColor=Green;       // color for the orders arrows
   ...
   int cnt=0;      
      ...
      {	      
	     ...
	     {	     		
		    ...
		    OrderSend(Symbol(),OP_SELL,mylotsi,SellPrice,slippage,sl,tp,"MyMEFx EA"+MagicNumber,MagicNumber,0,ArrowsColorDown);		    		    
		    return(0);
	     }
      ...
      if (myOrderType==2 && ContinueOpening) 
      {
	     ...
	     {			      
		    ...
		    if (mylotsi>100) { mylotsi=100; }
		    OrderSend(Symbol(),OP_BUY,mylotsi,BuyPrice,slippage,sl,tp,"MyMEFx EA"+MagicNumber,MagicNumber,0,ArrowsColorUp);		    
		    return(0);
	     }
      }   
}
   ...
   int cnt=0;
      ...
      {	
	     ...
	     //{		
		    ...
		    if (mylotsi>100) { mylotsi=100; }
		    OrderSend(Symbol(),OP_SELLLIMIT,mylotsi,SellPrice,slippage,sl,tp,"MyMEFx EA"+MagicNumber,MagicNumber,0,ArrowsColorDown);		    		    
		    return(0);
	     //}
      }
      ...
      if (myOrderType==2 && ContinueOpening) 
      {
	     ...
	     //{		
		    ...
		    if (mylotsi>100) { mylotsi=100; }
		    OrderSend(Symbol(),OP_BUYLIMIT,mylotsi,BuyPrice,slippage,sl,tp,"MyMEFx EA"+MagicNumber,MagicNumber,0,ArrowsColorUp);		    
		    return(0);
	     //}
      }   
