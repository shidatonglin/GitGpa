...
//|                                       I speak Russian:  PolyVi@yandex.ru |
//|                                      by original: Ким Игорь В. aka KimIV |
//|                                                      http://www.kimiv.ru |
//+--------------------------------------------------------------------------+
...
void start()
{
  ...
  double u4 = GetProfitFromDateInPoint("", -1, MagicNumber, d4) - u3 - u2 - u1 - u0;
  ...
  double p4 = GetProfitFromDateInCurrency("", -1, MagicNumber, d4) - p3 - p2 - p1 - p0;
  ...
  SetLabel("iProfit71", "week           ", ecText, eiX1Row, eiOffsetY + 8 * eiStepY);
  SetLabel("iProfit81", "month         ", ecText, eiX1Row, eiOffsetY + 9 * eiStepY);
  SetLabel("iProfit91", "quarter        ", ecText, eiX1Row, eiOffsetY + 10 * eiStepY);
  SetLabel("iProfit01", "year             ", ecText, eiX1Row, eiOffsetY + 11 * eiStepY);
  //+--------------------------------------------------------------------------+
  //|                                     POINTS                               |
  //+--------------------------------------------------------------------------+
  ...
  if (MagicNumber>=0) {
    ...
    string sep = "======= (Tracking Magic "+StringSubstr(m,StringLen(m)-10,10)+")========";
  }
