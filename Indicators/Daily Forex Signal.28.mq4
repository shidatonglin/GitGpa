...
int start() {
   ...
   alerts("AUDCHF", "label-02", "arrow-02", "ttp-02", "tp-02", "act-02", 2, 56);
   alerts("AUDJPY", "label-03", "arrow-03", "ttp-03", "tp-03", "act-03", 2, 74);
   alerts("AUDNZD", "label-04", "arrow-04", "ttp-04", "tp-04", "act-04", 2, 92);
   alerts("AUDUSD", "label-05", "arrow-05", "ttp-05", "tp-05", "act-05", 2, 110);
   alerts("CADCHF", "label-06", "arrow-06", "ttp-06", "tp-06", "act-06", 2, 128);
   alerts("CADJPY", "label-07", "arrow-07", "ttp-07", "tp-07", "act-07", 2, 146);
   
   alerts("CHFJPY", "label-08", "arrow-08", "ttp-08", "tp-08", "act-08", 225, 38);
   alerts("EURAUD", "label-09", "arrow-09", "ttp-09", "tp-09", "act-09", 225, 56);
   alerts("EURCAD", "label-10", "arrow-10", "ttp-10", "tp-10", "act-10", 225, 74);
   alerts("EURCHF", "label-11", "arrow-11", "ttp-11", "tp-11", "act-11", 225, 92);
   alerts("EURGBP", "label-12", "arrow-12", "ttp-12", "tp-12", "act-12", 225, 110);
   alerts("EURJPY", "label-13", "arrow-13", "ttp-13", "tp-13", "act-13", 225, 128);
   alerts("EURNZD", "label-14", "arrow-14", "ttp-14", "tp-14", "act-14", 225, 146);
   
   alerts("EURUSD", "label-15", "arrow-15", "ttp-15", "tp-15", "act-15", 480, 38);
   alerts("GBPAUD", "label-16", "arrow-16", "ttp-16", "tp-16", "act-16", 480, 56);
   alerts("GBPCAD", "label-17", "arrow-17", "ttp-17", "tp-17", "act-17", 480, 74);
   alerts("GBPCHF", "label-18", "arrow-18", "ttp-18", "tp-18", "act-18", 480, 92);
   alerts("GBPJPY", "label-19", "arrow-19", "ttp-19", "tp-19", "act-19", 480, 110);
   alerts("GBPNZD", "label-20", "arrow-20", "ttp-20", "tp-20", "act-20", 480, 128);
   alerts("GBPUSD", "label-21", "arrow-21", "ttp-21", "tp-21", "act-21", 480, 146);
   
   
   alerts("NZDCAD", "label-22", "arrow-22", "ttp-22", "tp-22", "act-22", 700, 38);
   alerts("NZDCHF", "label-23", "arrow-23", "ttp-23", "tp-23", "act-23", 700, 56);
   alerts("NZDJPY", "label-24", "arrow-24", "ttp-24", "tp-24", "act-24", 700, 74);
   alerts("NZDUSD", "label-25", "arrow-25", "ttp-25", "tp-25", "act-25", 700, 92);
   alerts("USDCAD", "label-26", "arrow-26", "ttp-26", "tp-26", "act-26", 700, 110);
   alerts("USDCHF", "label-27", "arrow-27", "ttp-27", "tp-27", "act-27", 700, 128);
   alerts("USDJPY", "label-28", "arrow-28", "ttp-28", "tp-28", "act-28", 700, 146);
