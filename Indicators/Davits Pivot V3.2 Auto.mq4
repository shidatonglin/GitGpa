...
extern bool autoTimeAdjustment =true;
extern int timeZoneOfData= -5;//TimeZoneOfData(NewYork GMT)
...
extern color chose_color_pivot = clrYellow;
extern color label_color_pivot = clrYellow;
extern int width_of_pivot_line = 0;
extern int line_style_of_pivot = 4;
extern color chose_color_R38 = clrMagenta;
extern color label_color_R38 = clrMagenta;
extern color chose_color_R61 = clrLime;
extern color label_color_R61 = clrLime;
extern color chose_color_R78 = clrRed;
extern color label_color_R78 = clrRed;
extern color chose_color_R100 = clrCyan;
extern color label_color_R100 = clrCyan;
extern color chose_color_R138 = clrOrange;
extern color label_color_R138 = clrOrange;
extern color chose_color_R161 = clrBlack;
extern color label_color_R161 = clrBlack;
extern color chose_color_R200 = clrDarkKhaki;
extern color label_color_R200 = clrDarkKhaki;
extern int width_of_R_line = 0;
extern int line_style_of_R = 0;
extern color chose_color_S38 = clrMagenta;
extern color label_color_S38 = clrMagenta;
extern color chose_color_S61 = clrLime;
extern color label_color_S61 = clrLime;
extern color chose_color_S78 = clrRed;
extern color label_color_S78 = clrRed;
extern color chose_color_S100 = clrCyan;
extern color label_color_S100 = clrCyan;
extern color chose_color_S138 = clrOrange;
extern color label_color_S138 = clrOrange;
extern color chose_color_S161 = clrBlack;
extern color label_color_S161 = clrBlack;
extern color chose_color_S200 = clrDarkKhaki;
extern color label_color_S200 = clrDarkKhaki;
extern int width_of_S_line = 0;
extern int line_style_of_S = 0;
...
//-------------------------------------------------------------------+
   ...
   if(autoTimeAdjustment==True)           //Automatic time adjusmtent for weekly pivots
      ...
      for(z=1;z<250;z++)
         ...
         if((iTime(NULL,PERIOD_H1,z)/3600/24)< (iTime(NULL,PERIOD_H1,z-1)/3600/24)&& TimeDayOfWeek((iTime(NULL,PERIOD_H1,z)))==5 && weekCount==0)
            {
            if(diffGMT<0)
               {
