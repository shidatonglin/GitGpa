...
int labelcolor;
   ...
   for(int i=0;i<ArraySize(TradePair);i++)  
       ...
       ObjectDelete("TotProf");
         ...
         if(OrdersTotal()==0){SetText("CTP","No Trades To Monitor",x_axis+722,y_axis-25,Yellow,8);}
         if(OrdersTotal()>0 ){SetText("CTP","Monitoring Trades",x_axis+722,y_axis-25,Yellow,8);}
         SetText("TPr","Basket TakeProfit = "+DoubleToStr(Basket_Target,0),x_axis+722,y_axis-5,Yellow,8);
         SetText("SL","Basket StopLoss = -"+DoubleToStr(Basket_StopLoss,0),x_axis+722,y_axis+15,Yellow,8);
        ...
        // SetPanel("TP1",0,x_axis+722,y_axis-27,125,20,Black,White,1);
        // SetPanel("TP2",0,x_axis+722,y_axis-8,125,20,Black,White,1);
        // SetPanel("TP3",0,x_axis+722,y_axis+11,125,20,Black,White,1);
         ...
         SetText("Trades","Buy       Sell    Total",x_axis+608,y_axis-17,White,8);
         //SetText("TTr","Lots              Orders",x_axis+730,y_axis-30,White,8);
         SetText("Tottrade","Profit",x_axis+722,y_axis+35,White,18);
         ...
         SetText("TProf"+IntegerToString(i),DoubleToStr(MathAbs(bprofit[i]),2),x_axis+608,(i*16)+y_axis,ProfitColor,8);
         SetText("SProf"+IntegerToString(i),DoubleToStr(MathAbs(sprofit[i]),2),x_axis+648,(i*16)+y_axis,ProfitColor2,8);
         SetText("TtlProf"+IntegerToString(i),DoubleToStr(MathAbs(tprofit[i]),2),x_axis+688,(i*16)+y_axis,ProfitColor3,8);
         SetText("TotProf",DoubleToStr(MathAbs(TotalProfit()),2),x_axis+722,y_axis+53,ProfitColor1,52);
         
       Create_Button(button_close_basket_All,"CLS ALL",60 ,18,x_axis+524,y_axis-25,clrRed,clrWhite);
       Create_Button(button_buy_basket_1,"B",20 ,15,x_axis+524,y_axis,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_1,"S",20 ,15,x_axis+548,y_axis,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_1,"C",20 ,15,x_axis+570,y_axis,clrRed,clrWhite);
       Create_Button(button_buy_basket_2,"B",20 ,15,x_axis+524,y_axis+16,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_2,"S",20 ,15,x_axis+548 ,y_axis+16,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_2,"C",20 ,15,x_axis+570 ,y_axis+16,clrRed,clrWhite);
       Create_Button(button_buy_basket_3,"B",20 ,15,x_axis+524,y_axis+32,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_3,"S",20 ,15,x_axis+548 ,y_axis+32,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_3,"C",20 ,15,x_axis+570 ,y_axis+32,clrRed,clrWhite);
       Create_Button(button_buy_basket_4,"B",20 ,15,x_axis+524,y_axis+48,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_4,"S",20 ,15,x_axis+548 ,y_axis+48,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_4,"C",20 ,15,x_axis+570 ,y_axis+48,clrRed,clrWhite);
       Create_Button(button_buy_basket_5,"B",20 ,15,x_axis+524,y_axis+64,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_5,"S",20 ,15,x_axis+548 ,y_axis+64,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_5,"C",20 ,15,x_axis+570 ,y_axis+64,clrRed,clrWhite);
       Create_Button(button_buy_basket_6,"B",20 ,15,x_axis+524,y_axis+80,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_6,"S",20 ,15,x_axis+548 ,y_axis+80,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_6,"C",20 ,15,x_axis+570 ,y_axis+80,clrRed,clrWhite);
       Create_Button(button_buy_basket_7,"B",20 ,15,x_axis+524,y_axis+96,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_7,"S",20 ,15,x_axis+548 ,y_axis+96,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_7,"C",20 ,15,x_axis+570 ,y_axis+96,clrRed,clrWhite);
       Create_Button(button_buy_basket_8,"B",20 ,15,x_axis+524,y_axis+112,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_8,"S",20 ,15,x_axis+548 ,y_axis+112,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_8,"C",20 ,15,x_axis+570 ,y_axis+112,clrRed,clrWhite);
       Create_Button(button_buy_basket_9,"B",20 ,15,x_axis+524,y_axis+128,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_9,"S",20 ,15,x_axis+548 ,y_axis+128,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_9,"C",20 ,15,x_axis+570 ,y_axis+128,clrRed,clrWhite);
       Create_Button(button_buy_basket_10,"B",20 ,15,x_axis+524,y_axis+144,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_10,"S",20 ,15,x_axis+548 ,y_axis+144,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_10,"C",20 ,15,x_axis+570 ,y_axis+144,clrRed,clrWhite);
       Create_Button(button_buy_basket_11,"B",20 ,15,x_axis+524,y_axis+160,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_11,"S",20 ,15,x_axis+548 ,y_axis+160,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_11,"C",20 ,15,x_axis+570 ,y_axis+160,clrRed,clrWhite);
       Create_Button(button_buy_basket_12,"B",20 ,15,x_axis+524,y_axis+176,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_12,"S",20 ,15,x_axis+548 ,y_axis+176,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_12,"C",20 ,15,x_axis+570 ,y_axis+176,clrRed,clrWhite);
       Create_Button(button_buy_basket_13,"B",20 ,15,x_axis+524,y_axis+192,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_13,"S",20 ,15,x_axis+548 ,y_axis+192,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_13,"C",20 ,15,x_axis+570 ,y_axis+192,clrRed,clrWhite);
       Create_Button(button_buy_basket_14,"B",20 ,15,x_axis+524,y_axis+208,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_14,"S",20 ,15,x_axis+548 ,y_axis+208,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_14,"C",20 ,15,x_axis+570 ,y_axis+208,clrRed,clrWhite);
       Create_Button(button_buy_basket_15,"B",20 ,15,x_axis+524,y_axis+224,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_15,"S",20 ,15,x_axis+548 ,y_axis+224,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_15,"C",20 ,15,x_axis+570 ,y_axis+224,clrRed,clrWhite);
       Create_Button(button_buy_basket_16,"B",20 ,15,x_axis+524,y_axis+240,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_16,"S",20 ,15,x_axis+548 ,y_axis+240,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_16,"C",20 ,15,x_axis+570 ,y_axis+240,clrRed,clrWhite);
       Create_Button(button_buy_basket_17,"B",20 ,15,x_axis+524,y_axis+256,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_17,"S",20 ,15,x_axis+548 ,y_axis+256,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_17,"C",20 ,15,x_axis+570 ,y_axis+256,clrRed,clrWhite);
       Create_Button(button_buy_basket_18,"B",20 ,15,x_axis+524,y_axis+272,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_18,"S",20 ,15,x_axis+548 ,y_axis+272,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_18,"C",20 ,15,x_axis+570 ,y_axis+272,clrRed,clrWhite);
       Create_Button(button_buy_basket_19,"B",20 ,15,x_axis+524,y_axis+288,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_19,"S",20 ,15,x_axis+548 ,y_axis+288,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_19,"C",20 ,15,x_axis+570 ,y_axis+288,clrRed,clrWhite);
       Create_Button(button_buy_basket_20,"B",20 ,15,x_axis+524,y_axis+304,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_20,"S",20 ,15,x_axis+548 ,y_axis+304,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_20,"C",20 ,15,x_axis+570 ,y_axis+304,clrRed,clrWhite);
       Create_Button(button_buy_basket_21,"B",20 ,15,x_axis+524,y_axis+320,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_21,"S",20 ,15,x_axis+548 ,y_axis+320,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_21,"C",20 ,15,x_axis+570 ,y_axis+320,clrRed,clrWhite);
       Create_Button(button_buy_basket_22,"B",20 ,15,x_axis+524,y_axis+336,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_22,"S",20 ,15,x_axis+548 ,y_axis+336,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_22,"C",20 ,15,x_axis+570 ,y_axis+336,clrRed,clrWhite);
       Create_Button(button_buy_basket_23,"B",20 ,15,x_axis+524,y_axis+352,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_23,"S",20 ,15,x_axis+548 ,y_axis+352,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_23,"C",20 ,15,x_axis+570 ,y_axis+352,clrRed,clrWhite);
       Create_Button(button_buy_basket_24,"B",20 ,15,x_axis+524,y_axis+368,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_24,"S",20 ,15,x_axis+548 ,y_axis+368,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_24,"C",20 ,15,x_axis+570 ,y_axis+368,clrRed,clrWhite);
       Create_Button(button_buy_basket_25,"B",20 ,15,x_axis+524,y_axis+384,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_25,"S",20 ,15,x_axis+548 ,y_axis+384,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_25,"C",20 ,15,x_axis+570 ,y_axis+384,clrRed,clrWhite);
       Create_Button(button_buy_basket_26,"B",20 ,15,x_axis+524,y_axis+400,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_26,"S",20 ,15,x_axis+548 ,y_axis+400,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_26,"C",20 ,15,x_axis+570 ,y_axis+400,clrRed,clrWhite);
       Create_Button(button_buy_basket_27,"B",20 ,15,x_axis+524,y_axis+416,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_27,"S",20 ,15,x_axis+548 ,y_axis+416,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_27,"C",20 ,15,x_axis+570 ,y_axis+416,clrRed,clrWhite);
        Create_Button(button_buy_basket_28,"B",20 ,15,x_axis+524,y_axis+432,clrRoyalBlue,clrWhite);           
       Create_Button(button_sell_basket_28,"S",20 ,15,x_axis+548 ,y_axis+432,clrGoldenrod,clrWhite);
       Create_Button(button_close_basket_28,"C",20 ,15,x_axis+570 ,y_axis+432,clrRed,clrWhite);  
        }
  }
