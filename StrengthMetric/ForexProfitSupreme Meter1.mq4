...
*/
#property copyright "Currency Strengh Meter"
#property link      "Currency Strengh Meter"
...
extern color HandleBackGroundColor = Black;
extern color DataTableBackGroundColor_1 = Black;
extern color DataTableBackGroundColor_2 = Black;
extern color CurrencysBackGroundColor = Black;
extern color HandleTextColor = Black;
extern color DataTableTextColor = DimGray;
extern color CurrencysTextColor = DimGray;
extern color TrendUpArrowsColor = Lime;
...
string gsa_196[28] = {"EURUSD", "GBPUSD", "AUDUSD", "NZDUSD", "USDCHF", "USDCAD", "USDJPY", "EURJPY", "GBPJPY", "CHFJPY", "CADJPY", "AUDJPY", "NZDJPY", "EURAUD", "EURCAD", "EURCHF", "EURGBP", "EURNZD", "GBPCHF", "GBPNZD", "GBPCAD", "GBPAUD", "AUDCAD",
      "AUDNZD", "AUDCHF", "NZDCAD", "NZDCHF", "CADCHF"};
...
void start() {
   ...
   if (ShowCurrencies && (!CurrenciesWindowBelowTable)) {
      ...
      f0_2("hdTxt", "Window", 69, "Currency Strengh Meter", "Courier new", g_color_236, 0, 34, -2, 0, 11);
   } else {
      f0_11("Window", "", 30, 4, 18, 11, 1, 0, g_color_216, g_color_216, 0, 0, 0);
      f0_2("hdTxt", "Window", 69, "Currency Strengh Meter", "Courier new", g_color_236, 0, 1, -2, 0, 11);
   }
   int li_16 = 14;
   li_24 = 2;
