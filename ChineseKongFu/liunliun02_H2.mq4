...
void OnTick()
{
   ...
   //---
   double white_10 = iCustom(Symbol(),120,"liun_interval_index", 1.0, 1.0, 1.2, 0.0, 8.0, 8.0, 1, 0);
   double white_11 = iCustom(Symbol(),120,"liun_interval_index",1.0, 1.0, 1.2, 0.0, 8.0, 8.0, 1, 1);
   
   double white_20 = iCustom(Symbol(),120,"liun_interval_index",1.0, 1.0, 1.2, 0.0, 8.0, 8.0, 0, 0);
   double white_21 = iCustom(Symbol(),120,"liun_interval_index",1.0, 1.0, 1.2, 0.0, 8.0, 8.0, 0, 1);
   
   double yellow_10 = iCustom(Symbol(),120,"liun_interval_trend", 0.0, 2.0, 3.0, 0.0, 20.0, 20.0, 0, 0);
   double yellow_11 = iCustom(Symbol(),120,"liun_interval_trend", 0.0, 2.0, 3.0, 0.0, 20.0, 20.0, 0, 1);
   
   double yellow_20 = iCustom(Symbol(),120,"liun_interval_trend", 0.0, 2.0, 3.0, 0.0, 20.0, 20.0, 1, 0);
   double yellow_21 = iCustom(Symbol(),120,"liun_interval_trend", 0.0, 2.0, 3.0, 0.0, 20.0, 20.0, 1, 1);
