...
//|    Generated at Thu May 09 16:31:00 EDT 2013
//+------------------------------------------------------------------+
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "D1H1 EA", 9, "Tahoma", LabelColor);
