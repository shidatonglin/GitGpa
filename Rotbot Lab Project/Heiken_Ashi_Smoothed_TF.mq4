...
//+------------------------------------------------------------------+
//|                                      Heiken Ashi Smoothed TF.mq4 |
//+------------------------------------------------------------------+
//|                                                      mod by Raff |
//+------------------------------------------------------------------+
//| Modified  by Khalil Abokwaik Feb,08, 2015                        |
//| http://www.forexfactory.com/abokwaik                             |
//| Replaced MODE_ by PRICE_ and added a time frame option           |
//+------------------------------------------------------------------+
...
//---- last counted bar will be recounted
   ...
   while(pos>=0)
     {
      maOpen=iMA(NULL,Time_Frame,MaPeriod,0,MaMetod,PRICE_OPEN,pos);
      maClose=iMA(NULL,Time_Frame,MaPeriod,0,MaMetod,PRICE_CLOSE,pos);
      maLow=iMA(NULL,Time_Frame,MaPeriod,0,MaMetod,PRICE_LOW,pos);
      maHigh=iMA(NULL,Time_Frame,MaPeriod,0,MaMetod,PRICE_HIGH,pos);
