...
double Buy3_2 = iMA(NULL, 0, MAPeriod, 0, MODE_SMA, PRICE_CLOSE, Current + 0);
...
double Sell3_2 = iMA(NULL, 0, MAPeriod, PRICE_CLOSE, MODE_SMA, PRICE_CLOSE, Current + 0);
double Sell4_1 = iStochastic(NULL, 0, 30, 0, MODE_SMA, MODE_SMA, 0, MODE_MAIN, Current + 0);
double Sell4_2 = 50;
...
double CloseBuy3_2 = iMA(NULL, 0, MAPeriod, 0, MODE_SMA, PRICE_CLOSE, Current + 0);
double CloseBuy4_1 = iStochastic(NULL, 0, 30, 0, MODE_SMA, MODE_SMA, 0, MODE_MAIN, Current + 0);
...
double CloseSell3_2 = iMA(NULL, 0, MAPeriod, 0, MODE_SMA, PRICE_CLOSE, Current + 0);
double CloseSell4_1 = iStochastic(NULL, 0, 30, 0, MODE_SMA, MODE_SMA, 0, MODE_MAIN, Current + 0);
      ...
      if(OrderType() <= OP_SELL &&  OrderSymbol() == Symbol()) {
         ...
         if(OrderType() == OP_BUY) {
            ...
            //+------------------------------------------------------------------+
                     ...
                     if (CloseSell1_1 > CloseSell1_2 && CloseSell2_1 < CloseSell2_2 && CloseSell3_1 > CloseSell3_2 && CloseSell4_1 > CloseSell4_2) Order = SIGNAL_CLOSESELL;
