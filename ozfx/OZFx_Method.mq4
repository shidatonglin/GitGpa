...
double Buy2_2 = 0;
double Buy3_1 = iStochastic(NULL, 0, 5, 3, 3, MODE_SMA, 0, MODE_MAIN, Current + 0);
double Buy3_2 = 0;
...
double Sell2_2 = 0;
double Sell3_1 = iStochastic(NULL, 0, 5, 3, 3, MODE_SMA, 0, MODE_MAIN, Current + 0);
double Sell3_2 = 0;

double CloseBuy1_1 = iAC(NULL, 0, Current + 0);
double CloseBuy2_1 = iAC(NULL, 0, Current + 0);
double CloseBuy3_1 = iStochastic(NULL, 0, 5, 3, 3, MODE_SMA, 0, MODE_MAIN, Current + 0);
...
double CloseSell3_1 = iStochastic(NULL, 0, 5, 3, 3, MODE_SMA, 0, MODE_MAIN, Current + 0);
      ...
      if(OrderType() <= OP_SELL &&  OrderSymbol() == Symbol()) {
         ...
         if(OrderType() == OP_BUY) {
            ...
            //+------------------------------------------------------------------+
                     ...
                     if (False && False && False) Order = SIGNAL_CLOSEBUY;
